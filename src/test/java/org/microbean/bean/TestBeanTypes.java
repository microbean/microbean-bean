...
final class TestBeanTypes {
  ...
  final void testSupertypesOfint() {
    ...
    assertEquals("int", beanTypes.name(ts.get(0)));
  }
  ...
  final void testBeanTypesOfint() {
    ...
    assertEquals("int", beanTypes.name(ts.get(0)));
    assertEquals("java.lang.Object", beanTypes.name(ts.get(1))); // per CDI specification
  }
  ...
  final void testDirectSupertypesOfObjectArrayAreASingleIntersectionType() {
    ...
    assertEquals(1, ts.size());
    assertEquals("java.io.Serializable&java.lang.Cloneable", beanTypes.name(ts.get(0))); // wut
  }
  ...
  final void testSupertypesOfObjectArray() {
    ...
    assertEquals("java.lang.Object[]", beanTypes.name(ts.get(0)));
    assertEquals("java.io.Serializable&java.lang.Cloneable", beanTypes.name(ts.get(1))); // wut
    assertEquals("java.lang.Object", beanTypes.name(ts.get(2)));
    assertEquals("java.io.Serializable", beanTypes.name(ts.get(3)));
    assertEquals("java.lang.Cloneable", beanTypes.name(ts.get(4)));
  }
  ...
  final void testBeanTypesOfObjectArray() {
    ...
    assertEquals(2, ts.size());
    assertEquals("java.lang.Object[]", beanTypes.name(ts.get(0)));
    assertEquals("java.lang.Object", beanTypes.name(ts.get(1)));
  }
  ...
  final void testSupertypesOfString() {
    ...
    assertEquals("java.lang.String", beanTypes.name(ts.get(0)));
    assertEquals("java.lang.Object", beanTypes.name(ts.get(1)));
    assertEquals("java.io.Serializable", beanTypes.name(ts.get(2)));
    assertEquals("java.lang.CharSequence", beanTypes.name(ts.get(3)));
    assertEquals("java.lang.Comparable", beanTypes.name(ts.get(4)));
    assertEquals("java.lang.constant.Constable", beanTypes.name(ts.get(5)));
    assertEquals("java.lang.constant.ConstantDesc", beanTypes.name(ts.get(6)));
  }
  ...
  final void testDirectSupertypesOfInterfaceBExtendsA() {
    ...
    assertEquals(2, ts.size());
    assertEquals("java.lang.Object", beanTypes.name(ts.get(0)));
    assertEquals("org.microbean.bean.TestBeanTypes.A", beanTypes.name(ts.get(1)));
  }
  ...
  final void testDirectSupertypesOfInterfaceCExtendsBAreInDeclarationOrder() {
    ...
    assertEquals("java.lang.Object", beanTypes.name(ts.get(0)));
    assertEquals("org.microbean.bean.TestBeanTypes.A", beanTypes.name(ts.get(1)));
    assertEquals("org.microbean.bean.TestBeanTypes.B", beanTypes.name(ts.get(2)));
  }
  ...
  final void testSupertypesOfListExtendsString() {
    ...
    assertEquals(5, ts.size());
    assertEquals("java.lang.Object", beanTypes.name(ts.get(0)));
    assertEquals("java.util.List", beanTypes.name(ts.get(1)));
    assertEquals("java.util.SequencedCollection", beanTypes.name(ts.get(2)));
    assertEquals("java.util.Collection", beanTypes.name(ts.get(3)));
    assertEquals("java.lang.Iterable", beanTypes.name(ts.get(4)));
  }
  ...
  final <T> void testSupertypesOfTypeVariable() throws ReflectiveOperationException {
    ...
    assertEquals(2, ts.size());
    assertEquals("T", beanTypes.name(ts.get(0)));
    assertEquals("java.lang.Object", beanTypes.name(ts.get(1)));
  }
