...
public interface Request<R extends Request<R>> {
  ...
  /**
   * Returns the {@link Selector} on behalf of which a request is
   * currently happening, or {@code null} if that information is not
   * available.
   *
   * <p>The default implementation of this method returns {@code
   * null}.  Overrides are encouraged.</p>
   *
   * @return the {@link Selector} on behalf of which a request is
   * currently happening, or {@code null} if that information is not
   * available
   *
  ...
  public R withSelector(final Selector selector);
